...
var memoizedContactList = memo3((BuiltMap<String, ContactEntity> contactMap,
        BuiltList<String> contactList, ListUIState contactListState) =>
    visibleContactsSelector(contactMap, contactList, contactListState));

List<String> visibleContactsSelector(BuiltMap<String, ContactEntity> contactMap,
    BuiltList<String> contactList, ListUIState contactListState) {
